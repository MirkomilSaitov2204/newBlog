                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                            ...
                            <select class="form-control" name="locale">
                                <option value="en"@if(isset($dataTypeContent->locale) && $dataTypeContent->locale == 'en') selected="selected"@endif>En</option>
                                <option value="uz"@if(isset($dataTypeContent->locale) && $dataTypeContent->locale == 'uz') selected="selected"@endif>Uz</option>
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i>Post Tags</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="category_id">Post tags</label>
                                <select class="js-example-basic-multiple form-control" name="tag[]" multiple="multiple">
                                    @if (isset($tags))
                                    @foreach($tags as $tag)
                                        <option value="{{ $tag->id }}"{{ $tagsForPost->contains($tag) ?'selected': '' }}>{{ $tag->name }}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
